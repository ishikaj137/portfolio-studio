document.addEventListener('DOMContentLoaded', async () => {
    ...
    /* --- Auto-detect Embedded Mode in Portfolio Modal --- */
    const isEmbedded = window.self !== window.top || window.location.search.includes('embedded');
    if (isEmbedded) {
        document.body.classList.add('embedded-mode');
        if (chatbotPanel) {
            chatbotPanel.classList.add('open', 'embedded-view');
        }
        if (floatingBtn) {
            ...
            messagesArea.innerHTML = `
                <div class="message-row bot">
                    <div class="message-bubble">
                        Namaste! 🙏 I am <strong>TriBoT</strong>, your official sovereign AI assistant for the Ministry of Tribal Affairs.
                        <br><br>
                        How may I assist you with schemes, gazettes, or scholarship guidelines today?
                    </div>
                </div>
            `;
        }
